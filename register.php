...
<body>
    <div class="container">
        <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['SCRIPT_NAME']); ?>" autocomplete="off" enctype="multipart/form-data">
            <h2 class="animate__animated animate__zoomIn text-center">Adopt a Pet Registration Form</h2>
            <hr />
            <?php
            if (isset($errMSG)) {
            ?>
            ...
            <hr />
            <a href='index.php'><button class="animate__animated animate__wobble animate__delay-1s text-center badge bg-white text-wrap" style="width: 6rem;" type='button'>Already registered? Click here!</a>
        </form>
    </div>
</body>
